...
class PopupMenu {
  ...
  Offset _calculateOffset(BuildContext context) {
    ...
    if (dx + menuWidth() > _screenSize.width && dx > 10.0) {
      double tempDx = _screenSize.width - menuWidth() - 10; // 距离右边10的安全距离
